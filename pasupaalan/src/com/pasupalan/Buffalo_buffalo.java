...
public class Buffalo_buffalo extends Activity {
    ...
    private void displayView(int position) {
        ...
        switch (position) {
        case 0:
            fragment = new Buffalo_general();
            break;
       case 1:
            fragment = new Buffalo_Search();
            break;
        
       /*case 2:
            fragment = new Buffalo_sales();
            break;*/
        ...
        if (fragment != null) {
            ...
            fragmentManager.beginTransaction()
                    .replace(R.id.content_frame1, fragment).commit();
    ...
    {
    	int[] pic = new int[]{R.drawable.general,R.drawable.search};
    List<HashMap<String,String>> list = new ArrayList<HashMap<String,String>>();
    
    HashMap<String,String> map = new HashMap<String,String>();
    
    map.put("list", "General");
